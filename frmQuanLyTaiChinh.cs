...
namespace Education_Manager
{
    public partial class frmQuanLyTaiChinh : Form
    {
        ...
        {
            if (Permissions.Contains("QL_HPSV"))
            {
                OpenChildForm(new frmQuanLyHocPhiSinhVien());
            }
            else
            {
        ...
        {
            if (Permissions.Contains("QL_HPN"))
            {
                OpenChildForm(new frmQuanLyHocPhiNganh());
            }
            else
            {
                MessageBox.Show("Bạn không có quyền truy cập chức năng này.", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
        ...
        {
            if (Permissions.Contains("QL_LTC"))
            {
                OpenChildForm(new frmQuanLyLoaiThuChi());
            }
            else
            {
                MessageBox.Show("Bạn không có quyền truy cập chức năng này.", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
        ...
        {
            if (Permissions.Contains("QL_PT") || Permissions.Contains("T_PT"))
            {
                OpenChildForm(new frmQuanLyPhieuThu());
            }
            else
            {
                MessageBox.Show("Bạn không có quyền truy cập chức năng này.", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
